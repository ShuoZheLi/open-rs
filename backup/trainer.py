...
class GRPOTrainer(Trainer):
    ...
    def _generate_and_score_completions(
        ...
        context = torch.no_grad() if self.entropy_coeff == 0.0 else nullcontext()
        with context:
    ...
    def _compute_loss(self, model, inputs):
        ...
        total_loss = ((adv_kl_ent_per_token_loss * completion_mask).sum(-1) / completion_mask.sum(-1).clamp(min=1.0)).mean()
